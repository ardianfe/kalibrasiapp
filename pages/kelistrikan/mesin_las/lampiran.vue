              ...
              <no-ssr>
                ...
                <div id="body-content" style="border: 1px solid black; background: white; margin-top: 2mm; padding: 2.7mm 4mm">
                  ...
                  <p style="margin-left: 40px; margin-top: 100px" class="b">a. TEGANGAN KELUARAN DC (V<sub>DC</sub>)</p>
									<v-layout justify-center align-center column style="margin-bottom: 200px">
                    <table class="text-xs-center" width="90%">
                      <thead>
                        <tr class="">
                          <th>SETTING</th>
                          <th colspan="2">PENUNJUKAN  STANDAR ( A )</th>
                          <th colspan="4">AKURASI</th>
                          <th>KETIDAKPASTIAN *)</th>
                          <th>SYARAT AKURASI</th>
                        </tr>
                        <tr class="">
                          <th rowspan="2">( A )</th>
                          <th colspan="2">( A )</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>162.3</td>
										...
										<p style="width: 85%;" class="mt-4 mb-0">
                    ...
                    <p style="width: 85%;">
                      Catatan : <br>
                        1. Harga-harga yang tercantum dalam tabel diatas telah dibulatkan ke 0.1 A	<br>
                        2. Akurasi adalah selisih antara nilai "Setting" dengan "Penunjukan Standar"
                      </p>
									</v-layout>
