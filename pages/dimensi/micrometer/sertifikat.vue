              ...
              <no-ssr>
                ...
                <div id="body-content" style="border: 1px solid black; background: white; margin-top: 2mm; padding: 2.7mm 4mm">
                  ...
                  <v-layout>
                    <v-flex xs6>
                      ...
                      <v-layout>
                        ...
                        <p class="roman" style="font-size: 9pt; margin: 0; height: 4.2mm;" v-html="': '+certificate.equipment.capacity"></p>
                      </v-layout>
                  ...
                  <v-layout row>
                    ...
                    <div>
                      <p class="roman" style="font-size: 9pt; margin: 0; height: 4.4mm; width: 300px;" v-html="certificate.standard.name"></p>
                  ...
                  <v-layout>
                    ...
                    <v-flex xs6>
                      <v-layout row>
                        ...
                        <p class="roman" style="font-size: 9pt; margin: 0; height: 4.2mm;">: <span contenteditable="true">{{certificate.env_condition.corrected_humidity}}</span></p>
                      </v-layout>
                    </v-flex>
                  </v-layout>
...
export default {
  ...
  head: {
    title: 'Sertifikat | Bidang Dimensi',
    meta: [
      {
        hid: 'Dimensi',
        name: 'Dimensi',
  ...
  methods: {
    ...
    elementMapping(data, owner) {
      ...
      this.certificate.equipment.capacity = data.deskripsi.kapasitas[0] + '<br> &nbsp;&nbsp;' + data.deskripsi.kapasitas[1] 
      ...
      this.certificate.equipment.manufacture = data.deskripsi.merk
      ...
      this.certificate.standard.name = data.alat_kalibrasi[0] + '<br>' + data.alat_kalibrasi[1]
      this.certificate.standard.traceability = data.ketelusuran
      this.certificate.env_condition = {
        room_temp: data.deskripsi.suhu_ruangan[0].toFixed(2) + ' - ' + data.deskripsi.suhu_ruangan[1].toFixed(2) + ' ' + data.deskripsi.suhu_ruangan[2],
        corrected_room_temp: data.deskripsi.suhu_terkoreksi[0].toFixed(2) + ' - ' + data.deskripsi.suhu_terkoreksi[1].toFixed(2) + ' ' + data.deskripsi.suhu_terkoreksi[2],
        humidity: data.deskripsi['kelembaban_%'] + ' %',
        corrected_humidity: data.deskripsi['kelembaban_terkoreksi_%'] + ' %',
      }
