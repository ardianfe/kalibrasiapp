                    ...
                    <v-layout>
                      ...
                      <thead>
                          <tr class="text-xs-center">
                            <th class="pa-2">No</th>
                            <th class="pa-2">Nilai Standar <br> (menit)</th>
                            <th class="pa-2">Penunjukan Alat <br> (menit)</th>
                            <th class="pa-2">Ketidakpastian Pengukuran <br> (menit)</th>
                          </tr>
                      </thead>
                      <tbody>
                          <tr>
                            <td class="pa-2">1</td>
                            <td class="pa-2">10</td>
                            <td class="pa-2">8.157</td>
                            <td class="pa-2">0.039</td>
                          </tr>
                          <tr>
                            <td class="pa-2">2</td>
                            <td class="pa-2">20</td>
                            <td class="pa-2">18.26</td>
                            <td class="pa-2">0.038</td>
                          </tr>
                          <tr>
                            <td class="pa-2">3</td>
                            <td class="pa-2">30</td>
                            <td class="pa-2">28.516</td>
                            <td class="pa-2">0.038</td>
                          </tr>
                          <tr>
                            <td class="pa-2">4</td>
                            <td class="pa-2">40</td>
                            <td class="pa-2">37.078</td>
                            <td class="pa-2">0.038</td>
                          </tr>
                          <tr>
                            <td class="pa-2">5</td>
                            <td class="pa-2">50</td>
                            <td class="pa-2">48.245</td>
                            <td class="pa-2">0.038</td>
                          </tr>
                          <tr>
                            <td class="pa-2">6</td>
                            <td class="pa-2">60</td>
                            <td class="pa-2">58.235</td>
                            <td class="pa-2">0.039</td>
                          </tr>
                      </tbody>
                    </table>
