          ...
          <v-card-text>
            ...
            <table style="width: 90%">
              <tr>
                ...
                <td style="width: 15%">{{data_ktp["ktp_termometer_acuan_(Axial)"].dari_sertifikat}}</td>
                <td style="width: 10%">C</td>
              </tr>
              <tr>
                <td>Asumsi k=2,0</td>
                <td>(µb1) :</td>
                <td>{{data_ktp["ktp_termometer_acuan_(Axial)"].mb1}}</td>
                <td>C</td>
              </tr>
            </table>
            ...
            <table style="width: 90%" class="mt-2">
              <tr>
                ...
                <td style="width: 15%">(dari sertifikat)  :</td>
                <td style="width: 15%">{{data_ktp.ktp_termometer_acuan_97733.dari_sertifikat}}</td>
                <td style="width: 10%">C</td>
              </tr>
              <tr>
                <td>Asumsi k=2,0</td>
                <td>(µb1) :</td>
                <td>{{data_ktp.ktp_termometer_acuan_97733.mb1}}</td>
                <td>C</td>
              </tr>
            </table>
...
<script>
import volHeader from '~/components/suhu/termo_dial.vue'
...
export default {
  ...
  head: {
    title: 'Lembar Kerja Termometer Digital | Bidang Suhu',
    meta: [
      {
        hid: 'Suhu',
        name: 'Suhu',
  ...
  data: () => ({
    ...
    data_ktp: {
      ...
      ktp_termometer_acuan_97733: {
        dari_sertifikat: 0,
        mb1: 0
      },
      "ktp_termometer_acuan_(Axial)": {
        dari_sertifikat: 0,
        mb1: 0
      }
    },
