                      ...
                      <v-flex>
                        <p class="helve i" style="font-size: 11pt; margin: 7px 0; height: 4.2mm;">: 3-09-19-00757</p>
									...
									<v-layout justify-center align-center column>
										<table style="width: 90%" class="mb-3">
                      <tr>
                        <td colspan="6" class="b pa-3">Kesalahan Nol Relatif  = 0 %</td>
                      </tr>
                      <tbody class="text-xs-center">
                        <tr class="b">
                          <td>Penunjukan <br> Pressure <br> Gauge </td>
                          <td>Harga <br> Sebenarnya <br> Rata-rata </td>
                          <td>Faktor <br> Kalibrasi </td>
                          <td>Penyimpangan <br> Faktor <br> Kalibrasi </td>
                          <td>Mampu <br> Ulang <br> Relatif </td>
                          <td>Ketidakpastian <br> Pengukuran </td>
                        </tr>
                        <tr>
                          <td>(MPa)</td>
                          <td>( tf )</td>
                        ...
                        <tr>
                          <td>Rata-rata faktor kalibrasi</td>
                          <td>&nbsp;</td>
                          <td>8.54084 </td>
                          <td>&nbsp;</td>
                          <td>&nbsp;</td>
