            ...
            <div id="printable" style="margin: auto; margin-top: 0px; min-width: 190mm; max-width: 190mm; height: 280mm;">
              <no-ssr>
                ...
                <div id="body-content" style="border: 1px solid black; background: white; margin-top: 2mm; padding: 2.7mm 4mm">
                  ...
                  <div style="width: 90%; margin-left: 40px" class="mt-2 mb-2">
                    <v-layout>
                      <v-flex xs1>
                    ...
                    <p class="b my-2">METODA LANGSUNG</p>
                  </div>
                      ...
                      <tr>
                        ...
                        <th colspan="4">Daerah Ukur = 0-750 Joule</th>
                      </tr>
                      <tr>
                        <td colspan="2">PEMERIKSAAN</td>
                        <td colspan="2">SYARAT</td>
                      </tr>
                      <tr>
                        <td>Sudut Jatuh ( ° )</td>
                        <td colspan="2">150</td>
                      ...
                      <tr>
                        <td>Lokasi Pendulum (mm)</td>
                        <td colspan="2">0.2</td>
                        <td colspan="2">Max 0.5 mm</td>
                      </tr>
                      <tr>
                        <td>Momen Joule</td>
                        <td colspan="2">401.271</td>
                        <td colspan="2">-</td>
                      </tr>
                      <tr>
                        <td>Energi Potensial Joule</td>
                        <td colspan="4">&nbsp;</td>
                      </tr>
                      <tr>
                        <td>100%</td>
                        <td colspan="2">748.78</td>
                        <td colspan="2">750 ± 7.50 *)</td>
                      </tr>
                      <tr>
                        <td>80%</td>
                        <td colspan="2">599.02</td>
                        <td colspan="2">600 ± 6.00 *)</td>
                      </tr>
                      <tr>
                        <td>70%</td>
                        <td colspan="2">524.15</td>
                        <td colspan="2">525 ± 5.25 *)</td>
                      </tr>
                      <tr>
                        <td>60%</td>
                        <td colspan="2">449.27</td>
                        <td colspan="2">450 ± 4.50 *)</td>
                      </tr>
                      <tr>
                        <td>50%</td>
                        <td colspan="2">374.39</td>
                        <td colspan="2">375 ± 3.75 *)</td>
                      </tr>
                      <tr>
                        <td>40%</td>
                        <td colspan="2">299.51</td>
                        <td colspan="2">300 ± 3.00</td>
                      </tr>
                      <tr>
                        <td>30%</td>
                        <td colspan="2">224.63</td>
                        <td colspan="2">225 ± 2.25</td>
                      </tr>
                      <tr>
                        <td>20%</td>
                        <td colspan="2">149.76</td>
                        <td colspan="2">150 ± 1.50</td>
                      </tr>
                      <tr>
                        <td>10%</td>
                        <td colspan="2">74.88</td>
                        <td colspan="2">75 ± 0.75</td>
                      </tr>
                      <tr>
                        <td>Pusat Perkusi (m)</td>
                        <td colspan="2">0.752</td>
                        <td>0.75</td>
                        <td>± 0.0075</td>
                      </tr>
                      <tr>
                        <td>Kecepatan Impak (m/s)</td>
                        <td colspan="2">5.2</td>
                        <td colspan="2">5.0 - 5.5</td>
                      </tr>
                      <tr>
                        <td>Energi yang diserap Joule</td>
                        <td colspan="2">-749.79</td>
                        <td>-750</td>
                        <td>± 7.50</td>
                      </tr>
                      <tr>
                        <td>Kerugian Gesekan Joule.</td>
                    ...
                    <p>
                      Ketidakpastian yang dilaporkan adalah ketidakpastian bentangan dengan tingkat <br>
                      kepercayaan 95%, dan k = 2 <br><br>
                          
                      Catatan*) Di Luar Lingkup Akreditasi KAN		
                    </p>
									</v-layout>
