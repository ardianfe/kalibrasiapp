          ...
          <v-card-text>
            ...
            <table width="100%">
              ...
              <tr style="font-size: 12px">
                ...
                <td>
                  <span v-for="(item, x) in data_kal.hk3['Unnamed: 5']" :key="x">
                    Posisi {{x+1}} :	{{item}}	Unit	Posisi 6  :	{{data_kal.hk3['Unnamed: 8'][x]}}	Unit <br>
                  </span> <br>
                            
                  H rata-rata :	{{data_kal.havg_3}} Unit	<br>
                  H Minimum :	{{data_kal.hmin_3}} Unit	<br>
                  H Maksimum : {{data_kal.h_max_3}} Unit	<br>
                </td>
                <td></td>
              </tr>
              <tr style="font-size: 12px">
                ...
                <td>
                  ...
                  H Maksimum : {{data_kal.h_max_3}} Unit <br>
                  H Minimun :	{{data_kal.hmin_3}} Unit <br><br>
                  Repeatability :	{{data_kal.repeatability_3}} Unit
                </td>
              ...
              <tr style="font-size: 12px">
                ...
                <td>
                  ...
                  H rata-rata :	{{data_kal.havg_3}} Unit <br>
                  H Standar :	{{data_kal.h_standar_3}} Unit <br><br>
                  Kesalahan :	{{data_kal.kesalahan_3}} Unit
                </td>
                <td> ± 3.0 unit</td>
              </tr>
            </table>
...
<script>
import tekananHeader from '~/components/gaya/hammer.vue'
