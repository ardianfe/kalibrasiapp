              ...
              <no-ssr>
                ...
                <div id="body-content" style="border: 1px solid black; background: white; margin-top: 2mm; padding: 2.7mm 4mm">
                  ...
                  <div style="width: 90%; margin-left: 40px" class="mt-2 mb-5">
                    ...
                    <v-layout>
                      <v-flex>
                        <p class="b helve u" style="font-size: 11pt; margin: 12px 0; height: 4.2mm;">Posisi: Tekan</p>
                        <p class="helve i" style="font-size: 9pt; margin: 0; height: 18px;">Position Compresion</p>
                      </v-flex>
                    </v-layout>
                  </div>

									<v-layout justify-center align-center column>
										<table cellspacing="0" border="0" style="font-size:10pt">
                      <colgroup span="8" width="107"></colgroup>
                      <tr>
                        <td colspan="2" align="left" >Resolusi Relatif <br><i>Relative of Resolution</i></td>
                        <td colspan="6" align="left" valign=center>: 0.5%</td>
                      </tr>
                      <tr>
                        <td colspan=2 align="left" >Kesalahan nol; relatif <br><i>Relative Error of zero</i></td>
                        <td colspan="6" align="left" valign=center>: 0%</td>
                      </tr>
                      
                      <tr>
                        <td rowspan="2">Julat Ukur <br> <i>Range</i> </td>
                        <td rowspan="2">Penunjukan Mesin <br> <i> Indicated by Machine</i> </td>
                        <td rowspan="2" colspan=2>Penunjukan Standard <br> <i> Indicated by Standard</i> </td>
                        <td colspan=2>Kesalahan Relatif <br> <i>Relative of Error</i></td>
                        <td rowspan="2" colspan=2>Ketidakpastian Pengukuran <br> <i>Uncertainty</i> </td>
                      </tr>
                      <tr>
                        <td>Ketelitian <br> <i>Accuracy</i></td>
                        <td>Mampu Ulang <br> <i>Repeatability</i></td>
                      </tr>
                      <tr>
                        <td>( kN )</td>
                        <td>( kN )</td>
                      ...
                      <tr>
                        ...
                        <td colspan=2  sdval="10.038" sdnum="1033;">10.038</td>
                        <td sdval="-0.38" sdnum="1033;">-0.38</td>
                        <td sdval="0.53" sdnum="1033;">0.53</td>
                        <td><br></td>
                        <td><br></td>
                      </tr>
                      <tr>
                        ...
                        <td  colspan=2  sdval="20.104" sdnum="1033;">20.104</td>
                        <td   sdval="-0.52" sdnum="1033;">-0.52</td>
                        <td   sdval="0.26" sdnum="1033;">0.26</td>
                        <td ><br></td>
                        <td  ><br></td>
                      </tr>
                      <tr>
                        ...
                        <td  colspan=2  sdval="40.221" sdnum="1033;">40.221</td>
                        <td   sdval="-0.55" sdnum="1033;">-0.55</td>
                        <td   sdval="0.26" sdnum="1033;">0.26</td>
                        <td align="right" >&plusmn;</td>
                        <td  align="left"  sdval="0.54" sdnum="1033;">0.54</td>
                      </tr>
                      <tr>
                        <td align="left" ><br></td>
                        <td  align="right"  sdval="60" sdnum="1033;">60</td>
                        <td  colspan=2  sdval="60.304" sdnum="1033;">60.304</td>
                        <td   sdval="-0.5" sdnum="1033;">-0.5</td>
                        <td   sdval="0.13" sdnum="1033;">0.13</td>
                        <td  colspan=2 >(Of Full Scale)</td>
                        </tr>
                      <tr>
                        <td ><br></td>
                        <td  align="right"  sdval="80" sdnum="1033;">80</td>
                        <td  colspan=2  sdval="80.404" sdnum="1033;">80.404</td>
                        <td   sdval="-0.5" sdnum="1033;">-0.5</td>
                        <td   sdval="0.06" sdnum="1033;">0.06</td>
                        <td ><br></td>
                        <td  ><br></td>
                      </tr>
                      <tr>
                        ...
                        <td  colspan=2  sdval="100.393" sdnum="1033;">100.393</td>
                        <td   sdval="-0.39" sdnum="1033;">-0.39</td>
                        <td   sdval="0.18" sdnum="1033;">0.18</td>
                        <td ><br></td>
                        <td  ><br></td>
                      </tr>
                    </table>
										<p style="width: 90%; margin-bottom: 200px">
