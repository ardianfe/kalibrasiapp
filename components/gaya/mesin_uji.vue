...
export default {
  data() {
    return {
      menus: [
        { name: 'gaya-mesin_uji-lk', text: 'Lembar Kerja', url: '/gaya/mesin_uji/lk?id='+this.$route.query.id },
        { name: 'gaya-mesin_uji-ktp', text: 'Ketidakpastian', url: '/gaya/mesin_uji/ktp?id=' +this.$route.query.id},
        { name: 'gaya-mesin_uji-lampiran', text: 'Lampiran', url: '/gaya/mesin_uji/lampiran?id=' +this.$route.query.id},
        { name: 'gaya-mesin_uji-sertifikat', text: 'Cetak Serifikat', url: '/gaya/mesin_uji/sertifikat?id='+this.$route.query.id }
      ]
    }
  },
