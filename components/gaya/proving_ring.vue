...
export default {
  data() {
    return {
      menus: [
        { name: 'gaya-proving_ring-lk', text: 'Lembar Kerja', url: '/gaya/proving_ring/lk?id='+this.$route.query.id },
        { name: 'gaya-proving_ring-ktp', text: 'Ketidakpastian', url: '/gaya/proving_ring/ktp?id=' +this.$route.query.id},
        { name: 'gaya-proving_ring-lampiran', text: 'Lampiran', url: '/gaya/proving_ring/lampiran?id=' +this.$route.query.id},
        { name: 'gaya-proving_ring-sertifikat', text: 'Cetak Serifikat', url: '/gaya/proving_ring/sertifikat?id='+this.$route.query.id }
      ]
    }
  },
