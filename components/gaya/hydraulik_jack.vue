...
export default {
  data() {
    return {
      menus: [
        { name: 'gaya-hydraulik_jack-lk', text: 'Lembar Kerja', url: '/gaya/hydraulik_jack/lk?cert_no='+ this.$route.query.cert_no +'&id='+this.$route.query.id },
        { name: 'gaya-hydraulik_jack-ktp', text: 'Ketidakpastian', url: '/gaya/hydraulik_jack/ktp?cert_no='+ this.$route.query.cert_no +'&id=' +this.$route.query.id},
        { name: 'gaya-hydraulik_jack-lampiran', text: 'Lampiran', url: '/gaya/hydraulik_jack/lampiran?cert_no='+ this.$route.query.cert_no +'&id=' +this.$route.query.id},
