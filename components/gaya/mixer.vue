...
export default {
  data() {
    return {
      menus: [
        { name: 'gaya-mixer-lk', text: 'Lembar Kerja & KTP', url: '/gaya/mixer/lk?id='+this.$route.query.id },
        { name: 'gaya-mixer-lampiran', text: 'Lampiran', url: '/gaya/mixer/lampiran?id=' +this.$route.query.id},
        { name: 'gaya-mixer-sertifikat', text: 'Cetak Serifikat', url: '/gaya/mixer/sertifikat?id='+this.$route.query.id }
      ]
    }
  },
