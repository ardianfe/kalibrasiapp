...
export default {
  data() {
    return {
      menus: [
        { name: 'gaya-uji_kekerasan-lk1', text: 'Lembar Kerja 1', url: '/gaya/uji_kekerasan/lk1' },
        { name: 'gaya-uji_kekerasan-lk2', text: 'Lembar Kerja 2', url: '/gaya/uji_kekerasan/lk2' },
        { name: 'gaya-uji_kekerasan-lk3', text: 'Lembar Kerja 3', url: '/gaya/uji_kekerasan/lk3' },
        { name: 'gaya-uji_kekerasan-sertifikat', text: 'Cetak Serifikat', url: '/gaya/sertifikat' },
        { name: 'gaya-uji_kekerasan-lampiran', text: 'Cetak Lampiran', url: '/gaya/uji_kekerasan/lampiran' }
      ]
    }
  },
