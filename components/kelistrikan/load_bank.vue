...
export default {
  data() {
    return {
      menus: [
        { name: 'kelistrikan-load_bank-lk', text: 'Lembar Kerja', url: '/kelistrikan/load_bank/lk' },
        { name: 'kelistrikan-load_bank-sertifikat', text: 'Cetak Serifikat', url: '/kelistrikan/load_bank/sertifikat' },
        { name: 'kelistrikan-load_bank-lampiran', text: 'Cetak Lampiran', url: '/kelistrikan/load_bank/lampiran' }
      ]
    }
  },
