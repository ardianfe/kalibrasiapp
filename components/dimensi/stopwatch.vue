...
export default {
  data() {
    return {
      menus: [
        { name: 'dimensi-stopwatch-lk', text: 'Lembar Kerja', url: '/dimensi/stopwatch/lk?id='+this.$route.query.id },
        { name: 'dimensi-stopwatch-cmc', text: 'CMC', url: '/dimensi/stopwatch/cmc?id='+this.$route.query.id },
        { name: 'dimensi-stopwatch-sertifikat', text: 'Sertifikat', url: '/dimensi/stopwatch/sertifikat?id='+this.$route.query.id },
        { name: 'dimensi-stopwatch-lampiran', text: 'Lampiran', url: '/dimensi/stopwatch/lampiran?id='+this.$route.query.id },
      ]
    }
  },
