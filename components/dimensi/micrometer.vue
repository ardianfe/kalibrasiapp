...
export default {
  data() {
    return {
      menus: [
        { name: 'dimensi-micrometer-lk', text: 'Lembar Kerja', url: '/dimensi/micrometer/lk?id='+this.$route.query.id },
        { name: 'dimensi-micrometer-sertifikat', text: 'Sertifikat', url: '/dimensi/micrometer/sertifikat?id='+this.$route.query.id },
        { name: 'dimensi-micrometer-lampiran', text: 'Lampiran', url: '/dimensi/micrometer/lampiran?id='+this.$route.query.id },
      ]
    }
  },
