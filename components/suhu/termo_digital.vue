...
export default {
  data() {
    return {
      menus: [
        { name: 'suhu-termometer_digital-lk', text: 'Lembar Kerja & KTP', url: '/suhu/termometer_digital/lk?id='+this.$route.query.id },
        { name: 'suhu-termometer_digital-sertifikat', text: 'Sertifikat', url: '/suhu/termometer_digital/sertifikat?id='+this.$route.query.id },
        { name: 'suhu-termometer_digital-lampiran', text: 'Lampiran', url: '/suhu/termometer_digital/lampiran?id='+this.$route.query.id },
      ]
    }
  },
