...
export default {
  data() {
    return {
      menus: [
        { name: 'suhu-autoclave-lk', text: 'Lembar Kerja & KTP', url: '/suhu/autoclave/lk?id='+this.$route.query.id },
        { name: 'suhu-autoclave-sertifikat', text: 'Sertifikat', url: '/suhu/autoclave/sertifikat?id='+this.$route.query.id },
        { name: 'suhu-autoclave-lampiran', text: 'Lampiran', url: '/suhu/autoclave/lampiran?id='+this.$route.query.id },
      ]
    }
  },
