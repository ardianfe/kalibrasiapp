...
export default {
  data() {
    return {
      menus: [
        { name: 'suhu-termometer_recorder-lk', text: 'Lembar Kerja & KTP', url: '/suhu/termometer_recorder/lk?id='+this.$route.query.id },
        { name: 'suhu-termometer_recorder-sertifikat', text: 'Sertifikat', url: '/suhu/termometer_recorder/sertifikat?id='+this.$route.query.id },
        { name: 'suhu-termometer_recorder-lampiran', text: 'Lampiran', url: '/suhu/termometer_recorder/lampiran?id='+this.$route.query.id },
      ]
    }
  },
