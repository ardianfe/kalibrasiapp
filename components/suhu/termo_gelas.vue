...
export default {
  data() {
    return {
      menus: [
        { name: 'suhu-termometer_gelas-lk', text: 'Lembar Kerja & KTP', url: '/suhu/termometer_gelas/lk?id='+this.$route.query.id },
        { name: 'suhu-termometer_gelas-sertifikat', text: 'Sertifikat', url: '/suhu/termometer_gelas/sertifikat?id='+this.$route.query.id },
        { name: 'suhu-termometer_gelas-lampiran', text: 'Lampiran', url: '/suhu/termometer_gelas/lampiran?id='+this.$route.query.id },
      ]
    }
  },
