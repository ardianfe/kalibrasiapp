...
export default {
  data() {
    return {
      menus: [
        { name: 'volumetrik-piknometer-lk', text: 'Lembar Kerja', url: '/volumetrik/piknometer/lk?id='+this.$route.query.id },
        { name: 'volumetrik-piknometer-ketidakpastian', text: 'Ketidakpastian', url: '/volumetrik/piknometer/ketidakpastian?id='+this.$route.query.id },
        { name: 'volumetrik-piknometer-sertifikat', text: 'Sertifikat', url: '/volumetrik/piknometer/sertifikat?id='+this.$route.query.id },
        { name: 'volumetrik-piknometer-lampiran', text: 'Lampiran', url: '/volumetrik/piknometer/lampiran?id='+this.$route.query.id },
      ]
    }
  },
